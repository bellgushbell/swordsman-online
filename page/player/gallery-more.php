...
<section class="more-gallery-section">
    ...
    <div class="gallery-container">
        ...
        <div class="gallery" id="videoGallery" style="display: none;">
            <div class="gallery-item large video-overlay card"
                ...
                <h3>ฝากตัวเป็นศิษย์กับสำนักที่ใช่!</h3>
            </div>
            <div class="gallery-item small-right video-overlay card"
...
<style>
    ...
    /* 3D effect for smooth hover */
    .card {
        transition: transform 0.2s ease-out, box-shadow 0.2s ease-out; /* Apply transition for smooth hover */
        will-change: transform;
    }

    .card:hover {
        transform: scale(1.05) rotateX(5deg) rotateY(-5deg); /* Smooth rotation effect */
...
<script>
    ...
    // Attach listeners dynamically to all cards
