...
$sql = "SELECT d.id,d.id_title,d.description,t.type,t.title,t.image FROM description d INNER JOIN title t ON d.id_title = t.id WHERE id_title = ?";
...
if ($result->num_rows > 0) {
    ...
    header("Location: ../../page/admin/content_admin.php");
    exit();
} else {
